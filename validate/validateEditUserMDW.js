const validateEditUserMDW = (req, res, next) => {
    ...
    if (errors && errors.length > 0) {
        res.locals.passValidateEditUser = false;
        res.locals.errorsValidateEditUser = [...errors];
    } else {
        res.locals.passValidateEditUser = true;
    }
...
module.exports = validateEditUserMDW;